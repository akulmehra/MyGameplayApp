    ...
    public class AuthRepository : IAuthRepository
    {
        ...
        private bool VerifyPassword(string password, User user)
        {
            ...
            using (var hmac = new System.Security.Cryptography.HMACSHA512(user.PasswordSalt)) {
                ...
                for(int x = 0; x < computedPasswordHash.Length; x++) {
                    if(computedPasswordHash[x] != user.PasswordHash[x]) {
                        return false;
                    }
                }
            }
        ...
        // Private method to create the Hash and Salt values for the password of a user
